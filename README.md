...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sas7bdat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12432&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sas7bdat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sas7bdat` can be installed with:

```
conda install sas7bdat
```

It is possible to list all of the versions of `sas7bdat` available on your platform with:
